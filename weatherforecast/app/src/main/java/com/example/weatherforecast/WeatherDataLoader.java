...
public class WeatherDataLoader {
    private static final String API_KEY = "426ea6dd30efaa6a3321c678df5eef94";
    ...
    public WeatherForecast getWeatherAndPostResults(String city, WeatherConditionsResultHandler handler) {
        try {
